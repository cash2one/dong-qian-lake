...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectProgress.month'
        db.alter_column('mysite_projectprogress', 'month', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'ProjectProgress.month'
        db.alter_column('mysite_projectprogress', 'month', self.gf('django.db.models.fields.IntegerField')(max_length=10))
