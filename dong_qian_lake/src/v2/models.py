...
class ProjectProgress(models.Model):
    ...
    problem = models.TextField(u'存在问题',blank=True)
    remark = models.TextField(u'备注',blank=True)
    photo1 = models.FileField(u'图片1',upload_to='dong-qian-lake-progress',blank=True,null=True)
    photo2 = models.FileField(u'图片2',upload_to='dong-qian-lake-progress',blank=True,null=True)
    photo3 = models.FileField(u'图片3',upload_to='dong-qian-lake-progress',blank=True,null=True)
    photo4 = models.FileField(u'图片4',upload_to='dong-qian-lake-progress',blank=True,null=True)
    photo5 = models.FileField(u'图片5',upload_to='dong-qian-lake-progress',blank=True,null=True)
